...
class TaskTests {
    ...
    fun createWithDefaultDifficulty() {
        ...
        onView(allOf(
            ...
            withText(mActivityTestRule.activity.applicationContext.resources
    ...
    fun createWithOneSkill() {
        ...
        onView(
            ...
            .check(matches(withText(mActivityTestRule.activity.resources
    ...
    fun createWithTwoSkills() {
        ...
        onView(allOf(
            childAtPosition(allOf(
                withId(R.id.cv),
                childAtPosition(withId(R.id.rv), 1)), 0)))
            .check(matches(isDisplayed()))
